export const COLORS = {
  ...
  accent:"#5b8def",cyan:"#3ce8ff",warn:"#f5a524",good:"#3ddc97",danger:"#ff5e5e",
} as const;
...
export const STATUS_COLORS:Record<string,{bg:string;text:string;border:string}>={
  ...
  REVIEWING:{bg:"rgba(245,165,36,.12)",text:"#f5a524",border:"rgba(245,165,36,.3)"},
  ...
  APPEALING:{bg:"rgba(245,165,36,.18)",text:"#f5a524",border:"rgba(245,165,36,.4)"},
  PENDING:{bg:"rgba(245,165,36,.12)",text:"#f5a524",border:"rgba(245,165,36,.3)"},
  ...
  FLAG:{bg:"rgba(245,165,36,.09)",text:"#f5a524",border:"rgba(245,165,36,.22)"},
